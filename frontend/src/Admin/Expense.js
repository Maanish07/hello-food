...
const Expense = () => {
  ...
  const handleAddExpense = async (newTask) => {
    try {
      ...
      fetchTasks();
      handleClose(); // Close the Add Expense modal after adding expense
    } catch (error) {
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 mb-16">
        ...
        {addExpense && <Addexpense onAddExpense={handleAddExpense} onClose={handleClose} />}
        <ul className="mt-8">
...
//           Add Expense
//         </button>
//         {addExpense && <Addexpense onAddExpense={handleAddExpense} />}
//         <ul className="mt-8">
//           {tasks.map((taskItem, index) => (
//             <li
//               key={index}
